...
def user_ask(query_text):
    ...
    embedding_function = OpenAIEmbeddings(openai_api_key="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")
    ...
    model = ChatOpenAI(openai_api_key="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")
